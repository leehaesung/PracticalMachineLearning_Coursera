---
title: "Human Excercise pattern and Recognition - Predicting weight lifting styles"
author: "Haesung Lee"
date: "Sunday, July 25, 2016"
output:
  html_document:
    highlight: tango
    theme: readable
...
```
On this submission, we would see that all the predicted values are correct and a score of `20\20` is obtained.
<br>
